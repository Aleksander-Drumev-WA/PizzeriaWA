...
namespace Pizzeria.Tests.Fixtures
{
    ...
    public class DatabaseFixture : IDisposable
    {
        ...
        {
            _connection = new SqlConnection("Server=127.0.0.1,1433;Database=WA.PizzaDB.Tests;Trusted_Connection=False;MultipleActiveResultSets=true;User=sa;Password=#sql-pass22_;TrustServerCertificate=True");
